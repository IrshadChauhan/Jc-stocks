        ...
        <div className="flex flex-col min-h-screen">
          <header className="px-4 lg:px-6 h-16 flex justify-between items-center border-b sticky top-0 bg-white/80 backdrop-blur-sm z-50">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-64">
                <div className="flex flex-col gap-4 mt-4">
                  <Link className="text-lg font-semibold hover:text-emerald-600 transition-colors" href="/mentorship">
                    Mentorship
                  </Link>
                  <Link className="text-lg font-semibold hover:text-emerald-600 transition-colors" href="/premium">
                    Premium
                  </Link>
                  <Link className="text-lg font-semibold hover:text-emerald-600 transition-colors" href="/2.0">
                    2.0
                  </Link>
                  <Link className="text-lg font-semibold hover:text-emerald-600 transition-colors" href="/jc-stocks">
                    JC Stocks
                  </Link>
                </div>
              </SheetContent>
